...
> Status of each story is tracked by GitHub issue labels (managed by the inception-mcp). Use `list_features` / `list_ready_issues` for the live view rather than this static file. This file is the design-time wave plan; live state is on GitHub.
